...
def log_likelihood(lsum, ldiff, l2, l3, lnk, lnpk, omega_m, omega_l, h, omega_b, YHe=0.24):
    
    """
    Compute the log-likelihood  log L = -chi^2 / 2.

    Free parameters : lsum, ldiff, l2, l3  (redshift evolution of log10_fstar10_by_cstar)
    Fixed parameters: asum, adiff, log10_fesc10, alpha_esc, log10Mcrit
    ...
    asum         =  9.4376e-01
    adiff        =  2.8934e-01
    log10_fesc10 = -8.1220e-01
    alpha_esc    = -7.8249e-02
    log10Mcrit   =  1.0174e+01
    ...
    model_z_arr, model_QHII_arr, model_tau_value = reion_uvlf_funcs.reionHist_model(lsum, ldiff, l2, l3, asum, adiff, a2, a3, log10Mcrit, log10_fesc10, alpha_esc, lnk, lnpk, cdict)
    ...
    model_allUVLF_arr, data_allUVLF_arr, sigma_allUVLF_arr = reion_uvlf_funcs.model_and_data_allUVLF(
        model_QHI_UVLF_arr, log10Mcrit, lsum, ldiff, l2, l3, asum, adiff, a2, a3, log10_fesc10, alpha_esc, lnk, lnpk, cdict)
